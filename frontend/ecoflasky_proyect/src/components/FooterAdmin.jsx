      ...
      <div className="overlap">
        <div className="header">
          ...
          <div className="nav-links">
            ...
            <Link to="/distruibidores" className="text-wrapper-2">DISTRUIBIDORES</Link>
            <Link to="/productos" className="text-wrapper-3">PRODUCTOS</Link>
            <Link to="/proveedores" className="text-wrapper-4">PROVEEDORES</Link>
            <Link to="/empleados" className="text-wrapper-5">EMPLEADOS</Link>
